...
class OrderController extends Controller
{
    ...
    public function getSalesrecordData()
    {
    ...
    {
        $this->validate($request, ['transport_cost'=>'required','vat_per'=>'required','vat_tk'=>'required','discount_per'=>'required','discount_tk'=>'required','total'=>'required','current_due'=>'required','paid'=>'required','due'=>'required','invoice_num'=>'required','sales_by'=>'required','sales_date'=>'required']); 
