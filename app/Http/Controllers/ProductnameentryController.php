...
class ProductnameentryController extends Controller
{
    /**
    ...
    {
        return view('backend/master/productnameentry-list');
    }



    public function getProductnameentryData()
    {
        $data = Productnameentry::latest()->get(); 
    ...
    {
        $this->validate($request, ['product_entry'=>'required']); 
        
        Productnameentry::updateOrCreate(
                                    ['id' => $request->productnameentry_id],
                                    [
                                        'product_entry' => ucwords($request->product_entry), 
                                        
                                    ]
                                );        
        if($request->productnameentry_id){
            $msg = "Product Entry Updated Successfully.";
        }
        else{
    ...
    {
        $del = Productnameentry::find($id)->delete();
