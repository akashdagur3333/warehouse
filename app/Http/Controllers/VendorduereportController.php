...
class VendorduereportController extends Controller
{
    /**
    ...
    {
      return view('backend/master/vendor-due-report');
    }


    public function getVendorduereportDatalist(Request $request){
        ...
        // ->
        $data = Vendor::whereBetween('created_at', [$fromdate, $todate])
        ->get();
